...
CREATE USER marketDbAdmin WITH ENCRYPTED PASSWORD 'prueba123';
CREATE DATABASE market WITH OWNER marketDbAdmin;


--INSERT INTO categorias (nombre, descripcion) VALUES ('Deporte', 'prueba1')

SELECT * FROM categorias


--INSERT INTO tipoDocumento (descripcion) VALUES ('Cédula')
--INSERT INTO tipoDocumento (descripcion) VALUES ('Nit')
